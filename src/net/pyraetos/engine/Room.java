...
public class Room{
	...
	private void constructColls(){
		...
		//BACK WALLS
		c = new CollisionPlane('z', new Vector(x-1f, 0f, z-16f+.05f), new Vector(x+9f, 2f, z-16f+.05f));
		colls.add(c);
		c = new CollisionPlane('z', new Vector(x+12f, 0f, z-16f+.05f), new Vector(x+22f, 2f, z-16f+.05f));
		colls.add(c);
