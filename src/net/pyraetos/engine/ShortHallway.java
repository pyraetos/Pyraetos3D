...
public class ShortHallway{
	...
	public ShortHallway(float x, float z){
		this.x = x;
		this.z = z;
	...
	private void constructColls(){
		...
		//RIGHT WALL
		c = new CollisionPlane('x', new Vector(x+3f, 0f, z), new Vector(x+3f, 2f, z-17f));
		colls.add(c);
		c = new CollisionPlane('x', new Vector(x+4f, 0f, z), new Vector(x + 4f, 2f, z-17f));
		colls.add(c);
		
		//FLOOR
		c = new CollisionPlane('y', new Vector(x-.5f, 0f, z), new Vector(x+3f, 0f, z-16f));
		colls.add(c);
	}
